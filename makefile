...
train-generic:
	uv run --env-file .env python kiva-iccv/train.py --do_train --do_test --test_on validation --use_neptune --epochs 50 --batch_size 128 --freeze_encoder --transformation_net